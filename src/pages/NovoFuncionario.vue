      ...
      <div class="responder-container">
        ...
        <form @submit.prevent="salvarFuncionario" class="form-content">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>CPF *</label>
              <input v-model="form.cpf" type="text" placeholder="000.000.000-00" maxlength="14" required />
            </div>
            ...
            <div class="form-group">
              <label>Cargo</label>
              <input v-model="form.cargo" type="text" placeholder="Ex: Analista" />
            </div>

            <div class="form-group">
              <label>Setor</label>
              <input v-model="form.setor" type="text" placeholder="Ex: TI" />
            </div>
          </div>
